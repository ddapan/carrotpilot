...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"LongitudinalControlMode", PERSISTENT},  // 0:视觉, 1:雷达, 2:融合
    ...
    {"HandsOffDetectionEnabled", PERSISTENT},        // 新增：启用脱手检测
    {"HandsOffWarningTime", PERSISTENT},             // 新增：脱手警告时间(秒)
    {"HandsOffDisableTime", PERSISTENT},             // 新增：脱手禁用时间(秒)
