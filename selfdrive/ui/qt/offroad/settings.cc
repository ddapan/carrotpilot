...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
  ...
  latLongToggles->addItem(new CValueControl("UseLaneLineSpeed", "车道线模式速度(0)", "Laneline mode, lat_mpc control used", "../assets/offroad/icon_logic.png", 0, 200, 5));
  latLongToggles->addItem(new CValueControl("UseLaneLineCurveSpeed", "车道模式弯道速度(0)", "Laneline mode, high speed only", "../assets/offroad/icon_logic.png", 0, 200, 5));
  ...
  latLongToggles->addItem(new CValueControl("LaneChangeNeedTorque", "变道需要扭动方向盘", "", "../assets/offroad/icon_logic.png", 0, 1, 1));
  ...
  startToggles->addItem(new CValueControl("LongitudinalControlMode", "BYD纵向控制模式", "选择纵向控制数据源: 0=纯视觉, 1=纯雷达, 2=雷达视觉融合", "../assets/offroad/icon_shell.png", 0, 2, 1));
