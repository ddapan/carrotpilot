...
def main(demo=False):
  ...
  while True:
    ...
    if custom_lat_delay > 0.0:
      ...
      if "liveDelay" in sm.data and sm.updated["liveDelay"]:
        lat_delay = sm["liveDelay"].lateralDelay + lat_smooth_seconds
      else:
        lat_delay = LAT_SMOOTH_SECONDS
    ...
    if model_output is not None:
      ...
      LP.parse_model(modelv2_send.modelV2)
      ...
      modelv2_send.modelV2.meta.desireLog = str(DH.desire) #carrot
      drivingdata_send.drivingModelData.meta.laneChangeState = DH.lane_change_state
      drivingdata_send.drivingModelData.meta.laneChangeDirection = DH.lane_change_direction


      modelv2_send.modelV2.meta.laneWidthLeft = float(LP.lane_width_left)
      modelv2_send.modelV2.meta.laneWidthRight = float(LP.lane_width_right)
#      modelv2_send.modelV2.meta.distanceToRoadEdgeLeft =  model_output['distanceToRoadEdgeLeft']
#      modelv2_send.modelV2.meta.distanceToRoadEdgeRight = model_output['distanceToRoadEdgeRight']
