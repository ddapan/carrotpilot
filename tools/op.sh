...
function op_setup() {
  ...
  sudo cp -f $OPENPILOT_ROOT/tools/carrot2-v7.desktop /usr/share/applications/
  cp -f $OPENPILOT_ROOT/tools/autostart_lauch.desktop /home/$LOGNAME/.config/autostart/
  sudo sh -c "sed -i 's|OPENPILOT_ROOT|$OPENPILOT_ROOT|g' /usr/share/applications/carrot2-v7.desktop /home/$LOGNAME/.config/autostart/autostart_lauch.desktop"
